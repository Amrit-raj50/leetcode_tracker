            ...
            <div className="h-[48px] mt-[32px] flex flex-col justify-end relative pl-4 sm:pl-8">
              ...
              >
                <img 
                  src={highlightImage} 
                  alt="" 
                  className="absolute w-[110%] max-w-none h-[180%] -top-[40%] -left-[5%] mix-blend-multiply hue-rotate-[-90deg] brightness-110 -z-10 transition-transform object-fill opacity-90 pointer-events-none" 
                />
                {loading ? (
